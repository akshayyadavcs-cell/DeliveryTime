...
namespace DeliveryCost
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            oShipment.lstPackages.Add(oPackage1);
            oShipment.lstPackages.Add(oPackage2);
            oShipment.lstPackages.Add(oPackage3);
    ...
    {
        public List<PackageCost> GetPackageCostandTime(Shipment oShipment)
        {
            DeliveryMethods deliveryMethods = new DeliveryMethods();

            List<PackageCost> packageCosts = new List<PackageCost>();


            for (int i = 0; i < oShipment.lstPackages.Count; i++)
            {
                
            }

            PackageCost packageCost1 = deliveryMethods.CalculateCost(oShipment.baseDeliveryCost, oShipment.lstPackages[0]);
            PackageCost packageCost2 = deliveryMethods.CalculateCost(oShipment.baseDeliveryCost, oShipment.lstPackages[1]);
            PackageCost packageCost3 = deliveryMethods.CalculateCost(oShipment.baseDeliveryCost, oShipment.lstPackages[2]);
